...
- transformer & GPT
  ...
  {% include figure.html path="assets/img/2025-04-28-Final/transformer.png"  class="col-10" %}
...
- Difference Between the Prefill and Decoding Phases in the Decoding Stack
  ...
  {% include figure.html path="assets/img/2025-04-28-Final/attacc.png"  class="col-10" %}
...
### Distributed Deep Learning
  ...
  {% include figure.html path="assets/img/2025-04-28-Final/DDL.png"  class="col-10" %}
...
As deep learning models continue to grow in size, it has become increasingly difficult to train large-scale models using only the memory and compute resources of a single GPU. One of the key approaches to overcoming this limitation is **Distributed Deep Learning** (DDL). DDL distributes model parameters or data across multiple GPUs or nodes, enabling parallel training. It is generally categorized into **Data Parallelism** and **Model Parallelism**<d-cite key="denneman2020multiGPU"></d-cite>.
  ...
  {% include figure.html path="assets/img/2025-04-28-Final/parallelism.png"  class="col-10" %}
...
### Intra-node & Inter-node Communication
  ...
  {% include figure.html path="assets/img/2025-04-28-Final/nodecomm.png"  class="col-10" %}
...
In DDL, **Collective Communication** is essential for synchronizing model parameters and efficiently distributing or aggregating data. This refers to communication patterns that involve exchanging or combining data across multiple processes or GPUs. These patterns are typically categorized into several common types, as outlined below<d-cite key="wikiCollectiveOp"></d-cite>.   
  {% include figure.html path="assets/img/2025-04-28-Final/CC.png"  class="col-10" %}
...
A **Network Interface Card** (NIC) is a hardware device used to connect a system to a network and enable communication. Traditional NICs are limited in functionality—they typically handle simple network-related operations or forward incoming packets to the host CPU. In contrast, a SmartNIC is an enhanced Ethernet device equipped with onboard processing cores, allowing it to support more general-purpose tasks. Recent research leveraging SmartNICs often focuses on offloading certain tasks from the host CPU, thereby reducing its workload and enabling more efficient communication.   
  ...
  {% include figure.html path="assets/img/2025-04-28-Final/smartnic.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/GEMM-GEMV.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/NeuPIMs.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/neupimsOverlap.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/NeuPIMs_result.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/PIM-PNM.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/Results.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/MHA_GQA_MQA.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/RING_basic.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/RING_upgrade.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/RING_arch.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/RING_small_eval.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/RING_large_eval.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/SPARSE_algo.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/SPARSE_aggregator.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/image.png"  class="col-10" %}
...
{% include figure.html path="assets/img/2025-04-28-Final/SPARSE_result.png"  class="col-10" %}
