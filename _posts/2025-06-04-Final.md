...
toc:
  - name: Abstract
    subsections:
    - name: System architecture aspect
    - name: Network aspect
  - name: Background
    subsections:
    - name: GEMM & GEMV
    - name: NDP & PIM
    - name: PIM/NDP & GPU/NPU Accelater Features
    - name: Explanation of Detailed Operations in LLM Transformers, Multi-Head Attention, and GEMM/GEMV Computation
    - name: Distributed Deep Learning
    - name: Intra-node & Inter-node Communication
    - name: Collective Communication
    - name: SmartNIC
  - name: LLM Serving optimized ​for computational characteristics
    subsections:
      - name: NeuPIMs Architecture
